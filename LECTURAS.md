...
| 10 | 5 | §13.5 (herramientas de WCET y análisis); §2.4 | — | El libro no tiene capítulo de multiprocesador — las anomalías de §2.4 son el gancho teórico; el resto es material del curso. WCET: medición vs. análisis estático vs. high-water-mark + margen. El lab multinúcleo usa **AMP de Zephyr** (sysbuild, una imagen por core) = planificación *particionada* medida; el contraste global/SMP va en la charla (FreeRTOS lo tiene en este chip; el SMP de Zephyr en Xtensa sigue no funcional) |
